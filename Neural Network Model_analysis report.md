...
#### Results:
 **Data Preprocessing**:
* The target variable for the model  in the given dataset is 'IS_SUCCESSFUL' column.which is " y" variable
     y=application_df['IS_SUCCESSFUL'].values 

* The feature variable in our model is:
...
* The column "EIN" and "NAME" are droped from the model.since they are neither targets nor features.
  ...
  ***first hiden layer***:
1 units =80 the input layer takes 80 features to capture a broad range of the pattern in the data.
2 activation ='relu' the relu activation function will accelerate the convergence.
3 input_dim=43
...
1 Batch Normalization Layers:Stabilizes and accelerates training.
2 Dropout: prevents overfitting.
3 Early Stopping:Monitors validation loss and stops training to prevent overfitting.
